...
interface LocalPreferenceDataSource {
    ...
    fun fittingFilteringProducts(productFilteredBrowseList: List<ProductBrowsing>): List<ShapeBrowsing>
    fun getProductsBrowsing(shapeBrowsingList: List<ShapeBrowsing>): Message
}